...
export default function SingleChoiceQuestion({question, answer, onAnswerChange}) {
    ...
    return (
        <div className="flex flex-col gap-4 my-6">
            ...
            <div className="space-y-3 mt-4">
                <label className="block text-sm font-medium text-slate-700 dark:text-darkCustom-300">Choose one
                    answer</label>
