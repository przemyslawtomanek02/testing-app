...
function NotFoundPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-darkCustom-1000">
      <div className="grid min-h-full place-items-center bg-white dark:bg-darkCustom-1000 px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-xl font-semibold text-indigo-100 dark:text-indigo-400">
            404
          </p>
          ...
          <div className="mt-6">
            <img
              src="/media/hamster-meme.gif"
              alt="Hamster not found"
